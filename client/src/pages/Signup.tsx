...
const Signup = () => {
    return (
            ...
            <div className="outerbox"  style={{position:'absolute', top:'22%', bottom:'30%', left:'35%', right:'35%',}}>   
            <Card elevation={5} style={{padding:30}}>
                <Typography style={{textAlign:'center',padding:10}} variant='h4'>Sign Up</Typography>
            <FormGroup>
            ...
            <Typography style={{fontSize:15, color:"grey", position: "absolute", top:"105%" }}>Existing User?
                <Link>
        Login</Link>
            </Typography>
            <Button
