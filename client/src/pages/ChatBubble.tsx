...
import { Card, Typography,CardContent, CardActions, TextField } from '@material-ui/core'

const ChatBubble = () => {
    return (
        <div>
            <Card elevation={3} style={{maxWidth:400,borderRadius:"17px",marginTop:15,padding:7}}>
